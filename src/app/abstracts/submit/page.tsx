    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-theme-primary mb-6">{t.abstracts.successThankYou}</p>
          <div className="glass-gold rounded-2xl p-6 mb-6 text-left">
            <p className="text-theme-primary text-sm mb-2">{t.abstracts.yourAbstractId}</p>
            <p className="text-[#F5B730] font-mono font-bold text-2xl tracking-wide">{state.trackId}</p>
            <p className="text-white/80 text-xs mt-2">{t.abstracts.useThisIdToTrack}</p>
          </div>
          <div className="glass rounded-xl p-4 mb-8 text-left border border-[#C9921A]/20">
            ...
            <p className="text-theme-primary text-sm mb-4">{t.abstracts.registerToSecure}</p>
